...
import { createTutor, getTutors, Availability, updateTutor, getTutorById, getTutorSessionsService , getAvailabilityByTutorIdService,getMyTutorProfile } from "./tutor.service";
...
export const getMyTutorProfiles = async (
  req: Request,
  res: Response
) => {
  try {
    ...
    const result = await getMyTutorProfile(user.id);
...
export const updateTutorProfileController = async (
  req: Request,
  res: Response
) => {
  try {
